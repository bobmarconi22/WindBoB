      ...
      {isLoaded && spot && (
        <div id="spot-by-id">
          ...
          <div id="images-container">
            ...
            <div id="small-images" style={{ zIndex: 2 }}>
              <img
                className="img-small"
                onClick={() => alert("Feature coming soon!")}
                src={spot.SpotImages[1] ? spot.SpotImages[1].url : ""}
                alt="image 2"
              />
              <img
                className="img-small"
                onClick={() => alert("Feature coming soon!")}
                src={spot.SpotImages[2] ? spot.SpotImages[2].url : ""}
                alt="image 3"
              />
              <img
                className="img-small"
                onClick={() => alert("Feature coming soon!")}
                src={spot.SpotImages[3] ? spot.SpotImages[3].url : ""}
                alt="image 4"
              />
              <img
                className="img-small"
                onClick={() => alert("Feature coming soon!")}
                src={spot.SpotImages[4] ? spot.SpotImages[4].url : ""}
                alt="image 5"
              />
              <button
                id="all-photos"
          ...
          <div id="desc-reviews-container">
            ...
            <p className="spot-desc" style={{ marginLeft: "60px" }}>
              {spot.description}
            </p>
